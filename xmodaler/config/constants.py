...
_K.G_ATTRIBUTION_IDS = 'G_ATTRIBUTION_IDS'

_K.G_BEHAVIOR_IDS = 'G_BEHAVIOR_IDS'

_K.G_OBJECT_IDS = 'G_OBJECT_IDS'

_K.G_SENTENCE_IDS = 'G_SENTENCE_IDS'
...
_K.CLASS_RESULTS = 'CLASS_RESULTS'

_K.SENT_RESULTS = 'SENT_RESULTS'

_K.CLASS_ATT_FEATS = 'CLASS_ATT_FEATS'

_K.HRNET_FEATS = 'HRNET_FEATS'
