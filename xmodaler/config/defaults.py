...
_C.MODEL.ATTRIBUTION_VOCAB_SIZE = 1000

_C.MODEL.BEHAVIOR_VOCAB_SIZE = 1000

_C.MODEL.OBJECT_VOCAB_SIZE = 1000

_C.MODEL.ATTRIBUTION_DIM = 512

_C.MODEL.BEHAVIOR_DIM = 512

_C.MODEL.OBJECT_DIM = 512
...
_C.LOSSES.AERFA_OBJECT = 0.5

_C.LOSSES.AERFA_ACTION = 0.5

_C.LOSSES.AERFA_STATUS = 0.5

_C.LOSSES.AERFA_SENTENCE = 0.5
