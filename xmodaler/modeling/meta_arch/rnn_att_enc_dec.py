...
class RnnAttEncoderDecoder(BaseEncoderDecoder):
    ...
    def _forward(self, batched_inputs):
        ...
        outputs_alpha = Variable(torch.zeros(batch_size, seq_len, 4).cuda())
        ...
        for t in range(seq_len):
            ...
            if self.decoder is not None:
                ...
                if kfg.SENT_RESULTS in decoder_out:
                    outputs_alpha[:, t] = decoder_out[kfg.SENT_RESULTS]
        ...
        inputs.update({kfg.SENT_RESULTS: outputs_alpha})
